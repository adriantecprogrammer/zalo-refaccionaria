...
<template>
    <div v-if="visible" class="card" id="confirm-modal" tabindex="-1" aria-hidden="true">
        ...
        <div class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 " @click.self="cancel">
            <div class="relative p-4 w-auto  max-h-full  opacity-0 scale-in-center"
                :class="{ 'scale-100 opacity-100': visible }">


                <div v-if="showError" id="toast-warning"
                    ...
                    <div class="ms-3 text-sm font-normal">No puede reanudar si el carrito esta lleno</div>
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="ml-4 max-h-64 overflow-y-auto">
                        <div v-for="(product, index) in getProducts(props.cart)" :key="index">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        <div class="flex items-center space-x-3 p-4 md:p-5 border-t border-gray-200 rounded-b">
                            <button type="button" @click="addProductCart"
                                ...
                                <!-- Icono Play SVG -->
                                <svg aria-hidden="true" class="w-5 h-5 mr-2 mt-1" fill="none" stroke="currentColor"
