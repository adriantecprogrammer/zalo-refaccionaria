        ...
        <div class="relative bg-white rounded-lg shadow">
          ...
          <div class="p-4 md:p-5 space-y-4">
            ...
            >
              <input
                v-model="userPin"
                class="rounded w-full border-none focus:outline-none focus:ring-0"
                type="text"
            ...
            <small v-if="showIcons && !isvalidatePin" class="text-red-600"
              >PIN inválido. Intente de nuevo o inicie sesión nuevamente</small
            >
            <small v-if="showIcons && isvalidatePin" class="text-green-600"
              >PIN válido. Procesando la orden</small
            >
          </div>
