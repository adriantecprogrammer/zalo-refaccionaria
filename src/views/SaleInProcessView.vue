        ...
        <tbody>
          ...
          >
            ...
            <button
              ...
              class="boton_detalle ml-8 px-2 py-2 mt-2 mb-2 text-white bg-primary-900 hover:bg-primary-1000 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm text-nowrap text-center"
            >
              Ver Detalles
            </button>
          </tr>
